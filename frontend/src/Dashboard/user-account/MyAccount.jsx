        ...
        
        {
          ...
          <div className='pb-[50px] px-[30px] rounded-md'>
            ...
            <div className='text-center mt-4'>
              ...
              <p className='text-color text-[15px] leading-6 font-medium'>{userData.email}</p>
              <p className='text-color text-[15px] leading-6 font-medium'>Blood Type: <span className='ml-2 text-headingColor text-[22px] leading-8'>{userData.bloodType}</span></p>
            </div>
