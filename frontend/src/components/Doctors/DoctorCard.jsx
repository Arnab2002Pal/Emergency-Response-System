  ...
  return (
    <div className="p-3 lg:p-5">
        ...
        <div className="mt-2 lg:mt-4 flex items-center justify-between">
          <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7  rounded'>{specialization}</span>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
          ...
          <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none hover:text-white'>
                <BsArrowRight />
              </Link>
